...
namespace SharedConstants {
  inline constexpr int CONSTANT_UNSPECIFIED = 0;
  inline constexpr int MAX_BLE_NAME_LENGTH = 29;
  inline constexpr int MAX_TOUCH_SAFE_TEMPERATURE = 40;
  inline constexpr int START_TEMPERATURE = 30;
  ...
  inline constexpr int MAX_HISTORY_CHUNK = 100;
} // namespace SharedConstants

...
&nbsp; | Name | Comment
-------|------|--------
1 | [PCB & Components](https://oshwlab.com/puzrin/reflow-table-pd) | Open the EasyEDA project and order both in a couple of clicks. Order the PCB first and the components second so the shipments can be combined.
...
10 | M3 countersunk hex screws 10 mm (×4) | [EDLJ-C16-M3-L10](https://jlcmc.com/product/s/E02/EDLJ/din-7991-gb-t-70.3-hex-socket-countersunk-head-screw). Black finish. Part of the cap's magnetic latch. The material should be magnetic; any non-stainless steel should work.
11 | [M2 4 mm insert nuts (×7)](https://www.aliexpress.com/item/1005008644449489.html) | Hardware for the head mount.
12 | [Magnets D6 L3 (×8)](https://www.aliexpress.com/item/1005010676875849.html) | Cap latch. N52 preferred, look for "magnets for 3d printers".
13 | [Magnets D4 L4 (×4)](https://www.aliexpress.com/item/1005010676875849.html) | Cap latch (two D4 L2 magnets are also fine). N52 preferred, look for "magnets for 3d printers".
14 | [Raspberry Pi 5 fan](https://www.aliexpress.com/item/1005006547048892.html) | Side-blowing fan for plate cooling.
15 | [AWG 26 wire](https://www.aliexpress.com/item/1005010779278423.html) | For the MCPCB head power wires only. Any 0.4 mm (0.126 mm²) tinned copper wire will work. The small cross-section helps reduce heat transfer.
...
> - If male connectors with boss pins (Liansheng FH-00147) are not available,
>   use any SMD 2 mm 2x10P connectors with a height of 4.6 mm or less (body + pins).
...
5 | 217°C soldering paste | Use it on the PCB heater power lines.
...
1. `main`: 1.6 mm, green (other colors for 4-layer PCBs are pricey).
   - Stencil is strongly recommended; it adds roughly $3 to the order and saves
     ...
     - Select "Confirm production file" to ensure the positioning holes are generated correctly.
...
1. `tray`, `cap_xxx`: SLA "JLC black resin" or MJF "PA12-HP nylon, black".
   ...
   - Nylon: about twice as expensive as SLA, but better-looking.
   - (!) With nylon, use `cap_mjf_pa12` (smaller holes for self-tapping screws). For
     SLA, use `cap_sla`.
